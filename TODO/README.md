...
- `game-wordlist` / `lexicon` - the curated data the generators consume. (The proposal's `master-wordlist` was retired when the lexicon layer replaced it - see [`../docs/architecture/lexicon/pipeline.md`](../docs/architecture/lexicon/pipeline.md).)
